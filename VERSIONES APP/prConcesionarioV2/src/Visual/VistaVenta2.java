...
public class VistaVenta2 extends JFrame {
	...
	public VistaVenta2(int codV, int codC, int id) {
	...
	private void BtnSigActionPerformed(ActionEvent evt) {
		...
		VistaFormaPago v = new VistaFormaPago(codigoV,codigoC,idVendedor,strDate,0,Double.parseDouble(txtPrecioFinal.getText()),"Venta");
		v.setVisible(true);
		dispose();
	}
	...
	public static void main(String args[]) {
	     try {
	      ...
	      java.awt.EventQueue.invokeLater(new Runnable() {
	          public void run() {
	        	 VistaVenta2 v = new VistaVenta2(0,0,0);
	          	v.setVisible(true);
