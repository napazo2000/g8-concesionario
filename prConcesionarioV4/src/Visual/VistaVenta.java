...
public class VistaVenta extends JFrame {
    ...
    public VistaVenta(int id, String rol) {
        ...
        //se necesitarán variables para vehiculos y usuarios
	...
	//inicia variables
	    ...
	    //añade lectura al ratón
        	...
        	//añade opciones al filtro vehículo
            ...
            //añade opciones al filtro cliente
...
//Añade lectura a la acción del ratón en la tabla vehiculo
    ...
    //Añade lectura a la acción del ratón en la tabla clientes
