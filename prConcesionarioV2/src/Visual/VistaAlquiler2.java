...
public class VistaAlquiler2 extends JFrame {
	...
	public VistaAlquiler2(int codV, int codC, int id) {
	...
	private void BtnBackActionPerformed(ActionEvent evt) {
		VistaAlquiler v = new VistaAlquiler(0);
		v.setVisible(true);
		dispose();
	}
	...
	private void BtnSigActionPerformed(ActionEvent evt) {
		...
		VistaFormaPago v = new VistaFormaPago(codigoV,codigoC,idVendedor,strDate,Integer.parseInt(txtNumDias.getText()),Double.parseDouble(precio.getText()),"Alquiler");
		v.setVisible(true);
		dispose();
	}
