...
public class VistaPanelCliente extends JFrame {
	...
	public void initComponents() {
		...
		Font italic = new Font("Arial", Font.ITALIC, 25);
	...
	public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(VistaPanelCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	VistaPanelCliente v = new VistaPanelCliente();
            	v.setVisible(true);
            }
        });
    } 
